...
@section('content')
    ...
    <x-ui.dashboard-card class="mb-6" title="Choose a farmer to shop from" subtitle="Filter by farmer/store, keyword, category, and availability.">
        <form method="GET" action="{{ route($marketplaceRoute ?? 'marketplace') }}" class="grid gap-4 lg:grid-cols-[1fr_220px_220px_220px_auto] lg:items-end">
            <div>
