...
@php
    ...
    $classes = match ($normalized) {
        'completed', 'delivered', 'approved', 'active', 'in stock', 'high', 'paid' => 'bg-emerald-100 text-emerald-800 ring-emerald-200 dark:bg-emerald-900/40 dark:text-emerald-200 dark:ring-emerald-800',
        ...
        'pending', 'pending verification', 'low stock', 'moderate' => 'bg-amber-100 text-amber-800 ring-amber-200 dark:bg-amber-900/40 dark:text-amber-200 dark:ring-amber-800',
...
<span {{ $attributes->merge(['class' => "inline-flex items-center rounded-full px-3.5 py-1.5 text-sm font-bold ring-1 {$classes}"]) }}>
