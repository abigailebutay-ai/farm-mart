...
@section('content')
    ...
    <div class="mt-5 grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        <x-ui.table-card title="Recent Orders" subtitle="Check each order and choose the next action.">
            ...
            <tbody class="divide-y divide-slate-100">
                @forelse($recentOrders ?? [] as $order)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-5 py-4"><a href="{{ route('orders.show', $order) }}" class="rounded-lg bg-emerald-700 px-4 py-2 text-sm font-bold text-white hover:bg-emerald-800">View Details</a></td>
                    </tr>
                @empty
