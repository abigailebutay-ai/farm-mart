...
@section('content')
    ...
    <section class="receipt-container mx-auto max-w-4xl rounded-2xl border p-6 shadow-sm md:p-8">
        <div class="flex flex-col gap-4 border-b border-slate-200 pb-6 md:flex-row md:items-start md:justify-between">
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-xl font-black">Farm-Mart</p>
                        <p class="receipt-meta text-sm">Farm-to-Market Platform</p>
                    </div>
                </div>
                <h2 class="mt-6 text-3xl font-black">Official Receipt</h2>
        ...
        <div class="grid gap-5 border-b border-slate-200 py-6 md:grid-cols-2">
            ...
            <div>
                ...
                <p class="text-sm"><span class="font-semibold">Order Date:</span> {{ $order->created_at->format('M d, Y h:i A') }}</p>
        ...
        <p class="receipt-meta mt-8 border-t border-slate-200 pt-5 text-center text-sm">
